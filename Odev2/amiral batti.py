...
#b=10 ise demekki tum gemiler batirilmis break ile baslangictaki fordan cikar.
        if (b == 10):
            ...
            m = int(input("-Tekrar oynamak icin '1' e basiniz , oyunu oynamak istemiyorsaniz '2' ye  basiniz:"))
            break;
#burda ise  yapilan atislar hak sayisini gecmisse cikar.cikmadan once tekrar oynamak isteyip istemedigini sorar.
        if (t == ((boyut*boyut)//3)-1):
#(boyut*boyut)//3)-1 bu ifadeyi yazmamin nedeni t 0 dan baslayip (boyut*boyut)//3) gider range en son t=(boyut*boyut)//3) olmaz ondan dolayi.
            print("-->MALESEF {}! OYUNU KAYBETİNİZ :(\n-SİZE VERİLEN HAKLAR BİTTİ.\nPUANİNİZ :{}".format(ad,puan))
            m=int(input("-Tekrar oynamak icin '1' e basiniz , oyunu oynamak istemiyorsaniz '2' ye  basiniz:"))
            break;
#fordan cikmadan once sordugu soru 1 ise yeni oyun baslar degilsede oyundan cikar.
    if(m == 2):
