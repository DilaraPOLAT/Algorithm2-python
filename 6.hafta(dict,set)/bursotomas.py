...
ogr_name = ["Id", "Ad", "Soyad", "Kaz_bolum", "Kac_Yıllık", "Kacinci_sinif", "Kardes_sayisi", "Aylık_gelir",
            "An-Ba_ayrımıveyasağmı"]
ogrenci = None
ogrenci_list = None
ogr_id = []
silinen = []
...
def ogrenci_istatislik():
    ...
    for i in ogrenci.keys():
        ...
        x = Aylık // Top_Aile
        print("{} Id'li öğrencinin ailesinin toplam aylık geliri = {}.\tKişi başına düşen aylık gelir = {}".format(i,
                                                                                                                   Aylık,
                                                                                                                   x))
        if x >= a:
            a = x
        ...
        if x <= b:
            ...
            p = i
    print()
    print("-> Kişi başına düşen aylık geliri en fazla olan öğrencinin id'si = {}\n"
          "-> Kişi başına düşen aylık geliri en az olan öğrencinin id'si = {}".format(k, p))
